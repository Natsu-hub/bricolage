...
function animation() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.js-hover-icon').forEach(function (link) {
...
function scroll() {
  ...
  var lazyLoaded = false; // Lazy load の処理が一度だけ行われるようにフラグを追加
    ...
    document.querySelectorAll('a[href*="#"]').forEach(function (link) {
      link.addEventListener('click', function (e) {
        ...
        if (target || hash === '#top') {
          e.preventDefault();
          removeLazyLoad();
          var position = target ? target.getBoundingClientRect().top + window.scrollY - headerHeight : 1;
...
function slide() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    var mvSlideElement = document.querySelector(".js-slide-mv");
    if (mvSlideElement) {
      var slideImgMv = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(mvSlideElement, {
        focus: 0,
        pagination: false,
        arrows: false,
        autoplay: true,
    ...
    var worksSlideElement = document.querySelector(".js-slide-works");
    function handleSplide() {
      if (!worksSlideElement) return;
      var splideInstance = worksSlideElement.splide;
      if (window.innerWidth >= 768) {
        if (!splideInstance) {
          splideInstance = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__.Splide(worksSlideElement, {
            type: "loop",
            perPage: 4,
            perMove: 1,
            autoplay: true,
        ...
        var listElement = worksSlideElement.querySelector(".splide__list");
        if (listElement) {
...
function text() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    splitTargets.forEach(function (target) {
      ...
      parts.forEach(function (part) {
        ...
        if (BR_RE.test(part)) {
          ...
          var _text = part.replace(/\s+/g, ' ').trim();
          for (var _i = 0, _Array$from = Array.from(_text); _i < _Array$from.length; _i++) {
            var ch = _Array$from[_i];
            if (ch === ' ') {
              // 行頭のスペースは無視（インデント対策）
              if (!atLineStart) {
              ...
              out += "<span class=\"char\" aria-hidden=\"true\">".concat(ch, "</span>");
              atLineStart = false;
            }
          }
        }
    ...
    var textEffects = document.querySelectorAll('.js-text-effect');
    textEffects.forEach(function (target) {
      var spans = target.querySelectorAll('.char');
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(spans, {
        autoAlpha: 0,
        y: '0.4em'
      }, {
        autoAlpha: 1,
...
/* harmony import */ var _contactFrom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_contactFrom */ "./js/_contactFrom.js");
/* harmony import */ var _slide__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_slide */ "./js/_slide.js");
/* harmony import */ var _img__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_img */ "./js/_img.js");
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_text */ "./js/_text.js");
/* harmony import */ var _mv__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./_mv */ "./js/_mv.js");
...
(0,_mv__WEBPACK_IMPORTED_MODULE_8__.mv)();
(0,_text__WEBPACK_IMPORTED_MODULE_7__.text)();
(0,_img__WEBPACK_IMPORTED_MODULE_6__.img)();
(0,_slide__WEBPACK_IMPORTED_MODULE_5__.slide)();
(0,_contactFrom__WEBPACK_IMPORTED_MODULE_4__.contactFrom)();
